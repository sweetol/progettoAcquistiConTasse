 ...
 */
class getTipoProdottiRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipoProdottiRepository' shared autowired service.
     *
     * @return \App\Repository\TipoProdottiRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipoProdottiRepository.php';

        return $container->privates['App\\Repository\\TipoProdottiRepository'] = new \App\Repository\TipoProdottiRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
