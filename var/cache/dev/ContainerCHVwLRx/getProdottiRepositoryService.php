 ...
 */
class getProdottiRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProdottiRepository' shared autowired service.
     *
     * @return \App\Repository\ProdottiRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProdottiRepository.php';

        return $container->privates['App\\Repository\\ProdottiRepository'] = new \App\Repository\ProdottiRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
